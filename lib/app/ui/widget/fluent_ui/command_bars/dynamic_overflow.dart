...
typedef DynamicOverflowChangedCallback = void Function(List<int> hiddenChildren);
...
class RenderDynamicOverflow extends RenderBox
    with ContainerRenderObjectMixin<RenderBox, DynamicOverflowParentData>,
  ...
  Size _computeDryLayout(BoxConstraints constraints,
    ...
    while (child != null && child != lastChild) {
      ...
      if (mainAxisExtent + childMainAxisExtent + overflowItemMainAxisExtent >
        ...
        crossAxisExtent =
            max(crossAxisExtent, overflowItemCrossAxisExtent);
        overflowed = true;
        break;
      }
      mainAxisExtent += childMainAxisExtent;
      crossAxisExtent = max(crossAxisExtent, childCrossAxisExtent);
      child = childAfter(child);
    }
    if (!overflowed && _alwaysDisplayOverflowWidget) {
      mainAxisExtent += overflowItemMainAxisExtent;
      crossAxisExtent = max(crossAxisExtent, overflowItemCrossAxisExtent);
    }
  ...
  void performLayout() {
    ...
    max(0.0, containerMainAxisExtent - mainAxisExtent);
