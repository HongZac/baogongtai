...
///生产派工单 报次品页面
class MesTaskCheckRecordPage extends BaseFormPage<MesTaskCheckRecordController>{

  Widget contentWidget(BuildContext context, MesTaskCheckRecordController _){
    return Column(
      children: [
        Padding(
  ...
  Widget taskWidget(BuildContext context, MesTaskCheckRecordController _){
    return Container(
  ...
  Widget checkRecordReportWidget(BuildContext context, MesTaskCheckRecordController _){
    return Container(
      alignment: Alignment.topCenter,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
