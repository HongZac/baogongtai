...
///生产派工单 详情页 设置页面
class MesTaskDetailSettingPage extends BaseSettingPage<MesTaskDetailSettingController>{

  @override
  List<Widget> tabPageView(BuildContext context, MesTaskDetailSettingController _) {
    return [
      if (_.type == 'tab')
  ...
  ///默认选项卡设置
  Widget initialIndexWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
  ...
  ///生产报工-任务信息显示设置
  Widget submitInfoFormWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
  ...
  ///生产报工-按钮显示设置
  Widget submitBtnWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: ListView(
            children: [
              ...
              ExpansionTile(
                ...
                children: List.generate(AppConfig.mesTaskSubmitOperationWayList.length, (index) {
                  ChoiceChipModel item = AppConfig.mesTaskSubmitOperationWayList[index];
                  return RadioListTile(
                    title: Text(
                      item.title,
                      style: Theme.of(context).textTheme.bodyLarge,
  ...
  ///生产报工-表单填写项显示设置
  Widget submitFormWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
  ...
  ///生产报工-表单填写设置
  Widget submitFormSettingWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: ListView(
            children: [
              ...
              SwitchListTile(
                contentPadding: const EdgeInsets.symmetric(vertical: 8, horizontal: 8),
                value: _.isSaveTheLastQtyData,
                onChanged: (bool? bool) {
                  controller.isSaveTheLastQtyDataOnChanged();
                },
                title: Text(
                  '保存上一次报工时填写的报工总数量数据',
                  style: Theme.of(context).textTheme.bodyLarge,
  ...
  ///生产报工-设备选单-车间过滤
  Widget submitFormDeviceDepFilterWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: Column(
  ...
  ///生产报工-设备选单-设备类别过滤
  Widget submitFormDeviceClassFilterWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: TreeView(
  ...
  ///生产报工-产品类别打印模板设置
  Widget submitInvClassTemplateWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
  ...
  ///报工单列表设置
  Widget submitListWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
  ...
  ///次品录入-任务信息显示设置
  Widget checkRecordInfoFormWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
  ...
  ///次品录入-按钮显示设置
  Widget checkRecordBtnWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: ListView(
            children: [
              ...
              ExpansionTile(
                ...
                children: List.generate(AppConfig.mesTaskCROperationWayList.length, (index) {
                  ChoiceChipModel item = AppConfig.mesTaskCROperationWayList[index];
                  return RadioListTile(
                    title: Text(
                      item.title,
                      style: Theme.of(context).textTheme.bodyLarge,
  ...
  ///次品录入-表单填写项显示设置
  Widget checkRecordFormWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: controller.customScrollFormGroupSettingWidget(
            context,
            scrollController: _.cRFormScrollController,
            sliverList: [],
  ...
  ///次品录入-表单填写设置
  Widget checkRecordFormSettingWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: ListView(
  ...
  ///次品录入-设备选单-车间过滤
  Widget checkRecordFormDeviceDepFilterWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: Column(
  ...
  ///次品录入-设备选单-设备类别过滤
  Widget checkRecordFormDeviceClassFilterWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: TreeView(
  ...
  ///次品录入-产品类别打印模板设置
  Widget checkRecordInvClassTemplateWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: controller.invClassFrxNameMapSettingWidget(
  ...
  ///材料不良-任务信息显示设置
  Widget materialRejectInfoFormWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
  ...
  ///材料不良-按钮显示设置
  Widget materialRejectBtnWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: ListView(
  ...
  ///材料不良-表单填写项显示设置
  Widget materialRejectFormWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: controller.customScrollFormGroupSettingWidget(
  ...
  ///材料不良-表单填写设置
  Widget materialRejectFormSettingWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: ListView(
  ...
  ///材料不良-产品类别打印模板设置
  Widget materialRejectInvClassTemplateWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: controller.invClassFrxNameMapSettingWidget(
  ...
  ///次品单列表设置
  Widget checkRecordListWidget(BuildContext context, MesTaskDetailSettingController _){
    return Column(
      children: [
        Expanded(
          child: controller.customScrollInfoFormGroupSettingWidget(
