...
///工序 次品列表
class MesCheckRecordListPage extends BaseFormWithPageDataPage<MesCheckRecordListController, MoCheckRecordModel>{

  @override
  Widget headWidget(BuildContext context, MesCheckRecordListController _) {
    return Padding(
  ...
  @override
  Widget dataItem(BuildContext context, MesCheckRecordListController _, MoCheckRecordModel item){
    return Padding(
                      ...
                      Container(
                        ...
                        child: Wrap(
                          ...
                          children: _.getFieldList(
                            ...
                            item: item,
                            isMaterialReject: _.checkRecordDocumentTypeIndex == 1,
                          ),
                        ),
                      ),
                      AnimatedCrossFade(
  ...
  String disposeFlowContent(int? disposeFlow){
    switch (disposeFlow){
      case 1:
        return '报废';
      case 7:
