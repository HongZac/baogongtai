...
import 'package:desktop/app/ui/pages/home/mes/mes_device_task/mes_device_task_item.dart';
...
///生产 设备对应生产派工单
class MesDeviceTaskPage extends BaseFormPage<MesDeviceTaskController> {

  @override
  Widget contentWidget(BuildContext context, MesDeviceTaskController _){
    return LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints){
      return buildContent(context, _, constraints);
    });
  }

  Widget buildContent(BuildContext context, MesDeviceTaskController _, BoxConstraints constraints){
    return Container(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                MineIconButton(
                  onPressed: () {
                    Get.rootDelegate.toNamed(AppRoutes.MES_DEVICE_TASK_SETTING_PAGE);
                  },
  ...
  Widget deviceTaskList(BuildContext context, MesDeviceTaskController _){
    return Container(
      padding: const EdgeInsets.all(4),
      child: GridView.builder(
          ...
          itemCount: _.deviceFilterList.length,
          itemBuilder: (BuildContext context, int index){
            ModelWithGetxController<EAMDeviceModel> item = _.deviceFilterList[index];
            return MesDeviceTaskItem(tag: 'MesDeviceTask-${item.model.deviceId}');
          }
      ),
    );
  }
