...
import 'er_device_dialog_controller.dart';


///工作流程-设备异常报告弹出窗体
class ERDeviceDialogPage extends ExceptionReportBaseDialogPage<ERDeviceDialogController>{

  @override
  Widget contentWidget(BuildContext context, ERDeviceDialogController _){
    return Column(
      children: [
        ///设备信息
        Row(
