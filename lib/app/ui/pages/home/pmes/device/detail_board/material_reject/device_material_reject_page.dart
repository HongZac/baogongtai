...
///机台报工 不良品上报页面
class DeviceMaterialRejectPage extends BaseFormPage<DeviceMaterialRejectController> {

  @override
  Widget contentWidget(BuildContext context, DeviceMaterialRejectController _) {
    return Column(
      children: [
        if (_.showAppBar)
                  ...
                  child: MineIconButton(
                    onPressed: () {
                      Get.rootDelegate.toNamed(
                          AppRoutes.PMES_REAL_TIME_MONITOR_MATERIAL_REJECT_SETTING_PAGE,
                          parameters: {
  ...
  Widget taskWidget(BuildContext context, DeviceMaterialRejectController _){
    return Container(
  ...
  Widget checkRecordReportWidget(BuildContext context, DeviceMaterialRejectController _) {
    return Container(
      alignment: Alignment.topCenter,
      child: Column(
        children: [
