...
///工作流程-全场呼叫 填单窗体 基类
class DeviceAndonBaseDialogController extends BaseDialogController{
  ...
  DeviceAndonBaseDialogController({required this.deviceId, required this.wfSchemeInfo});
  ...
  ///创建流程实例
  Future<bool> saveWfParameter(String sourceId, String desc, String teamCode, String teamName) async{
