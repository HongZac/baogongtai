...
///生产 报工单列表
class PMesSubmitListPage extends BaseFormWithPageDataPage<PMesSubmitListController, MoOpSubmitModel>{

  @override
  Widget headWidget(BuildContext context, PMesSubmitListController _) {
    return Padding(
              ...
              builder: (BuildContext context, BoxConstraints constraints){
                return Container(
                  ...
                  child:  _.commandBarWidget(
                    context,
                    commandBarList: _.pMesSubmitListCommandBarList,
  ...
  @override
  Widget dataItem(BuildContext context, PMesSubmitListController _, MoOpSubmitModel item){
    return Padding(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          if (item.attach != null && item.attach! > 0)
                            TextButton(
                              onPressed: () async{
                      ...
                      Container(
                        ...
                        child: Wrap(
                          ...
                          children: _.getFieldList(
                            context,
                            infoFormList: _.pMesSubmitListInfoFormListMap[0] ?? [],
                            item: item,
                          ),
                        ),
                      ),
                      AnimatedCrossFade(
                        ...
                        Wrap(
                          ...
                          children: _.getFieldList(
                            context,
                            infoFormList: _.pMesSubmitListInfoFormListMap[1] ?? [],
                            item: item,
                          ),
                        ),
